...
class AddNewActivityRequirementResultModal extends Component {
  ...
  render() {
    const { showActivityRequirements } = this.props;
    return (
      <>
        <>
          <Modal
          ...
          >
            ...
            >
            Activity Requirement Successfully Created
            </ModalHeader>
            <ModalBody className="w-100 scrollable-modal confirm-modal">
						  Do you want to create one more ?
            </ModalBody>
            <ModalFooter className="mfooterGT">
              <Button className="ld-button-success" type="submit" onClick={this.submit}>
                Create one more
              </Button>
              {/* <Button className="ld-button-info" type="submit" onClick={() => showActivityRequirements()}>
                Show Activity Requirements
              </Button> */}
...
export default connect(mapStateToProps, mapDispatchToProps)(AddNewActivityRequirementResultModal);
