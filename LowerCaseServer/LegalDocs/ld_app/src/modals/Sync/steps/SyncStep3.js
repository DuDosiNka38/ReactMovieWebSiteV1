...
class SyncStep3 extends PureComponent {
  Stat = {
    New_Files_Size: 0,
    Remove_Locations: 0,
    Scanned_Folders: 0,
  ...
  render() {
    const { Stat, isScanned, isCountdown, countdownSec, inProcess, syncMessage } = this.state;
      ...
      <>
        <div className="sync-step-block__header">
          <div className="sync-step-block__header-title">
            <div className="sync-step-block__header-title-step">Step 3</div>
            <div className="sync-step-block__header-title-step-text">Parse Files</div>
          </div>
        </div>
        <div className="sync-step-block__body">
          {isInit ? (
            <>
              ...
              {SyncData && inProcess && SyncData.length > 0 && (
...
export default connect(mapStateToProps, mapDispatchToProps)(SyncStep3);
