...
class Pagination extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <div className={`d-flex justify-content-${this.totalPages > 1 ? "between" : "end"}`}>
          {this.totalPages > 1 &&
          ...
          <nav aria-label="Pagination Per Page">
            <ul className="pagination">
              {[this.fixedPageLimit, this.fixedPageLimit*2, this.fixedPageLimit*5, this.fixedPageLimit*10, this.fixedPageLimit*20, this.fixedPageLimit*50].map((x) => (
                <>
                  <li key={x} className={`page-item${
                        this.pageLimit === x ? " active" : ""
                      }`}>
                    <a
                      className="page-link"
                      href="#"
                      onClick={() => this.setPageLimit(x)}
                    >
                    {x}
                    </a>
                  </li>
